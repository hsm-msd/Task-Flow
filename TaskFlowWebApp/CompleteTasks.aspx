<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompleteTasks.aspx.cs" MasterPageFile="~/Site.Master" Inherits="TaskFlowWebApp.CompleteTasks" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div id="rcorners2">
        ...
        <div id="rcorners3" style="float:left; display:flex; flex-direction: column; align-items: center;" >
            ...
            <div class="parent-container">
                 <div >
                    ...
                    <button style='font-size:18px; display:inline-block; color:black' > <i class="fa-solid fa-check"></i>  Complete </button>
        ...
        <div id="stylebox">
                <h1 style="font-family:'Bookman Old Style'" >Complete Tasks</h1><br />
                <asp:Button ID="Button1" runat="server" Text="Click me to see Completed tasks" OnClick="ShowCompleteTasks" class="btn btn-info" style="margin-bottom:10px;" />
