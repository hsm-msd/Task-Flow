<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllTasks.aspx.cs" MasterPageFile="~/Site.Master" Inherits="TaskFlowWebApp.AllTasks" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div id="rcorners2">
          ...
          <div id="profilePic" onclick="openFileInput()" style="
            ...
            <div class="parent-container">
             <div >
                ...
                <button style='font-size:18px; display:inline-block; color:black' runat="server" > <i class="fa-solid fa-house" ></i>  All Tasks </button>              
        ...
        <div id="stylebox">
            <h1 style="font-family:'Bookman Old Style'"  >All Tasks</h1><br />
            <asp:Button ID="Button1" runat="server" Text="Click me to see all tasks" OnClick="ShowTasks" class="btn btn-info" style="margin-bottom:10px;" />
               ...
               <asp:ListView ID="lvTasks" runat="server">
                    <ItemTemplate >
                        <div class="task-item container mt-3" style="display: flex; align-items: center;" >
                                ...
                                <asp:Button ID="completeTask" runat="server" Text="Mark as Complete" 
                              CommandArgument='<%# Eval("id") %>' OnClick="completeTask_Click" class="btn btn-success" style="margin-left:10px" />
                        </div>
                    </ItemTemplate>
                </asp:ListView>
                     <div >
         ...
         <div>
                ...
                <asp:Panel ID="taskDetail" runat="server"  BackColor="LightSteelBlue"  BorderStyle="Ridge"  cssClass="modal-xl" Style="display: none; min-width:300px">
                    <div cssClass="modal " >
